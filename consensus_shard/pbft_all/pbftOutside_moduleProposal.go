...
func (crom *ProposalRelayOutsideModule) HandleMessageOutsidePBFT(msgType message.MessageType, content []byte) bool {
	switch msgType {
	case message.CRelay:
...
func (crom *ProposalRelayOutsideModule) handleRelay(content []byte) {
...
func (crom *ProposalRelayOutsideModule) handleInjectTx(content []byte) {
...
func (crom *ProposalRelayOutsideModule) handlePartitionMsg(content []byte) {
...
func (crom *ProposalRelayOutsideModule) handlePartitionReady(content []byte) {
...
func (crom *ProposalRelayOutsideModule) handleAccountStateAndTxMsg(content []byte) {
